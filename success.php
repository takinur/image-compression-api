...
<form id="form" enctype="multipart/form-data" name="imageUpload">
    ...
    <p style="text-align: center;">Please upload <b>18-25</b> photos where your face is clearly visible (crop if necessary)</p>

    <br>

    <small>	&#8259Upload photos with different lighting, facial expressions and locations<br>

      &#8259No teeth, no sunglasses, no nudes or inappropriate content<br>

      &#8259Avoid having other faces in your photos<br><br>
      
      The better the images, the better the results.</small>
  ...
  <div id="success">
    ...
    <h4>Everything looks great! &#x2705<br>
    
    The AI nanobots have started crafting your Digital You.<br><br>
    
    You will receive an email with your content in the next 3 hours. Check PROMOTIONS tab (or junk email).</h4>
  ...
  <script>
    ...
    form.addEventListener("submit", e => {
      ...
      //File Validation - 18 to 25 images

      if(pondFiles.length < 18){ 

        return alert("You need to load more images for the magic to happen. Please make sure you have a minimum of 18 images of yourself.")

      }
      if (pondFiles.length > 25){

       return alert("We love your enthusiasm! The AI nanobots only need 25 pictures of you. Please make sure not to exceed this limit.");
      ...
      //Total size should be less thab 30MB
        ...
        async function compressFile(orgFile){
          ...
          //Compression Config Options -  1MB, 512px, PNG
      ...
      async function sendFiles(){
        ...
        <body>
            ...
            <section>
                ...
                <p>We are happy to confirm that we have received your order for a DigitalYou AI avatar 😊 Your order is being worked on by our team of AI nanobots, and you can expect to receive your avatar via email in just a few hours.</p>
                ...
                <p>If you have not received an email from us within a few hours, please check the Promotions tab in your email inbox. If you still cannot find the email, please check your junk email folder and any other tabs or folders you may have.

                <br><br>

If the problem persists after 24hrs, please dont hesitate to contact this email for further assistance.</p>
