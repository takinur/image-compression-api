...
<form id="form" enctype="multipart/form-data" name="imageUpload">
    ...
    <p style="text-align: center"><b>18 to 25</b></p>
  ...
  <script>
    ...
    pond = FilePond.create(input,
    {
      ...
      labelIdle: 'Select your Images - <span class="filepond--label-action">Browse</span>',
    ...
    form.addEventListener("submit", e => {
      ...
      //Total size should be less thab 30MB
        ...
        if(totalSize > 1024 * 1024 * 30){
          alert("The total size of your images is too big. Please make sure the total size is less than 30MB.");
          return;
        }
        ...
        async function compressFile(orgFile){
          ...
          try {
            ...
            const newFile = new File([compressedFile], 
              file.name.includes("jpg") || file.name.includes("jpeg") ? file.name.replace(/jpg|jpeg/gi, "png") : file.name, 
